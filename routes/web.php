...
Route::get('/vaccinations/definitive_vaccination/{id}', 'VaccinationsController@definitive_vaccination')->middleware('auth')->name('vaccinations.definitive_vaccination');
